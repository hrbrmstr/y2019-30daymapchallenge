...
x <- gtable_filter(ggplot_gtable(ggplot_build(gg)), "guide-box")
...
ggplot() +
  ...
  annotation_custom(x$grobs[[1]]$grobs[[1]], xmin = -66, xmax = -66.8854, ymin = 46, ymax = 47) +
  annotation_custom(x$grobs[[1]]$grobs[[2]], xmin = -68, xmax = -66.8854, ymin = 42, ymax = 45) +
  scale_fill_distiller(palette = "YlGn", direction = 1) +
  scale_size_area() +
